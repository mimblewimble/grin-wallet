...
fn parse_contract_amounts(args: &ArgMatches) -> Result<(Option<u64>, Option<u64>), ParseError> {
...
fn parse_contract_selection(
	args: &ArgMatches,
) -> Result<(Option<String>, Option<Vec<u64>>), ParseError> {
