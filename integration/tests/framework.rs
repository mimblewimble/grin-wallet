...
impl LocalServerContainer {
	...
	fn make_wallet_for_tests(
		...
		let client_n = HTTPNodeClient::new(&self.wallet_config.check_node_api_http_addr, None, None);
	...
	pub fn get_wallet_info(
		...
		let client_n = HTTPNodeClient::new(&config.check_node_api_http_addr, None, None);
