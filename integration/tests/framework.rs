...
extern crate bitgrin_apiwallet as apiwallet;
extern crate bitgrin_libwallet as libwallet;
extern crate bitgrin_refwallet as wallet;
extern crate bitgrin_wallet_config as wallet_config;
...
impl Default for LocalServerContainerConfig {
	fn default() -> LocalServerContainerConfig {
		LocalServerContainerConfig {
			...
			api_server_port: 18513,
			p2p_server_port: 18514,
			wallet_port: 18515,
			owner_port: 18520,
...
pub fn stratum_config() -> servers::common::types::StratumServerConfig {
	servers::common::types::StratumServerConfig {
		...
		stratum_server_addr: Some(String::from("127.0.0.1:18516")),
		attempt_time_per_block: 60,
		minimum_share_difficulty: 1,
		wallet_listener_url: String::from("http://127.0.0.1:18515"),
		burn_reward: false,
	}
}
